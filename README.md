...
└── components/
    ├── SetupScreen.tsx         # Имена + выбор опций
    ├── GameScreen.tsx          # Буквы сверху, именные +1 внизу
    ├── WinnerScreen.tsx        # Имя победителя + счёт
    └── PrimaryButton.tsx       # Кнопка с onPointerDown (multitouch-safe)
```
